...
* **Background Notifications**: Even when minimized, the app stays active in the system tray to monitor broadcast status and send notifications.
* **Completely Free**: No ads, no payments. Just enjoy the experience!
...
* **Target OS**: Windows 10/11 (Lower versions are not supported)
* **Developer**: THESALT STUDIO

## Notes
- This application operates based on data from the streaming platforms **CHZZK** and **SOOP**.
- This is not an official application of either streaming platform.
- Actual streaming happens on the respective websites; this program serves only as a centralized hub.
